...
class TestResourcesPositive:
    ...
    def test_get_resource_by_id(self, client):
        ...
        exp_json = [{'active': True, 'created_at': '2018-10-10 10:10:10', 'id': 1, 'title': 'Sample Resource', 'updated_at': '2018-10-11 10:10:15'}]
        assert response.status_code == 200
        assert response.json == exp_json
    ...
    def test_add_resource(self, client):
        ...
        post_response = client.post(
            "/resources",
            json=dict(title='Test Resource', active=True)
        )
